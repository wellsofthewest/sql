...
CREATE TABLESPACE SDE DATAFILE '/home/oracle/orcl/oradata/stark/sde.dbf'
...
Select count(*) from dba_objects where owner='EDGIS' and status='INVALID';


--12. Compile any invalid schema objects:

Exec dbms_utility.compile_schema(schema => 'EDGIS');
